...
# Set up the screen
wn = turtle.Screen()
wn.title("Falling skies by TAPESH")
wn.bgcolor("black")
...
for _ in range(20):
    ...
    good_thing.speed = random.randint(0, 2)
...
for _ in range(20):
    ...
    bad_thing.speed = random.randint(0, 2)
...
pen.hideturtle()
pen.goto(0, 240)
pen.write("Score: 0  Lives: 3", align="center", font=("Comic Sans MS", 30, "normal"))
...
while True:
    ...
    for good_thing in good_things:
        ...
        if player.distance(good_thing) < 40:
            ...
            # Show the score
            pen.clear()
            pen.write("Score: {}  Lives: {}".format(score, lives), align="center", font=("Comic Sans MS", 30, "normal"))
    ...
    if lives == 0:
        pen.clear()
        pen.write("Game Over! Score: {}".format(score), align="center", font=("Comic Sans MS", 30, "normal"))
        wn.update()
        time.sleep(5)
        score = 0
        lives = 3
